        ...
        */
        ...
        //Branch A.
          ...
          function decisionThreeBrC2(){
              ...
              if (document.getElementById("list-option-1").checked == true){
                herbTier3 = "The sheep herder often collects herbs for the herbalist from the hills around his home.  He has already dried a bushel and a half for her that he would have been bringing down in a few days.  When you enquire if they are for sale, he offers to share what he would have been paid in return for delivering them to the herbalist and saving him the trip down to the village. <p>In addition to that, he has a task for you.  With his share of the pay, he would have you buy a number of needed supplies from the general store and deliver them back to him at his hut.  In trade, he would pay you a few copper and a warm cloak made from the wool sheared from his sheep.</p><p>In need of a new cloak you agree to the sheep herder's deal and return to the village to deliver the herbs and pick up the requested goods.  The day is reaching its end once you have finished buying the goods from the general store, so you wait to head out at first light.  The sheep herder is pleased at your arrival.  He pays you with the warmest of the cloaks made from his sheep's wool and the few coppers.</p>";
                document.getElementById("tier3").innerHTML = herbTier3;
